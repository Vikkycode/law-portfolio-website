  ...
  return (
    <section className=''>
        ...
        data-aos-duration="3000">
          ...
          <div className='h-[1056px] w-[353px] lg:w-[860px] -mb-48 lg:-mb-0 lg:h-[610px]'
          data-aos="fade-up"
          data-aos-duration="3000">
        ...
        data-aos="fade-right"
        data-aos-duration="3000">
          <div className='max-w-[1300px] mx-auto flex justify-between items-starts flex-col lg:flex-row  min-h-[80vh]  pt-[33rem] px-4 -pt-40 lg:pt-16'>
          <Image 
          src={image2}
          height={324}
          width={640}
          ...
          />
          <div className='w-[353px] lg:w-[520px] pt-8 lg:pt-20 h-[24px]'
          data-aos="fade-left"
          data-aos-duration="3000">
            <p className='font-[400] text-[16px]  w-[353px] lg:text-[20px] lg:leading-[28px] tracking-[-2%]'>Interested in learning more about Chief Mike Agbedor Abu Ozekhome's legal expertise? Or to see how he can help you with your legal needs</p>
            <div className={`${style.Button} w-[160px] mt-5`}>
